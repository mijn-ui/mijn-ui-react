  ...
  return (
    <div className="not-prose grid grid-cols-2 gap-4 pb-6">
      {previous ? (
        <Link
          href={previous.url}
          className="flex w-full flex-col gap-2 rounded-large border-small bg-fd-card p-4 text-small transition-colors hover:opacity-hover hover:text-fd-accent-foreground"
        >
      ...
      {next ? (
        <Link
          href={next.url}
          className={
            "col-start-2 flex w-full flex-col gap-2 rounded-large border-small bg-fd-card p-4 text-end text-small transition-colors hover:opacity-hover hover:text-fd-accent-foreground"
          }
        >
