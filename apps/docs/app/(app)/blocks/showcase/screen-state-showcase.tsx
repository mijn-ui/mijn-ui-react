...
const ScreenStateShowcase = () => {
  return (
    <div className="flex w-full max-w-screen-sm flex-col items-center justify-center space-y-2 rounded-2xl bg-surface p-4 text-center text-surface-text shadow-small">
