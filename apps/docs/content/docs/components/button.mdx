...
<ComponentPreview>
<div className="flex items-end flex-wrap gap-4">
  <Button iconOnly size="xs">xs</Button>
  <Button iconOnly size="sm">sm</Button>
  <Button iconOnly size="md">md</Button>
  <Button iconOnly size="lg">lg</Button>
  <Button iconOnly size="xl">xl</Button>
</div>
</ComponentPreview>
...
<Button iconOnly size="md">md</Button>
<Button iconOnly size="lg">lg</Button>
<Button iconOnly size="xl">icon</Button>
```
