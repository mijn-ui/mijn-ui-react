    ...
    mijnui({
      layout: {
        ...
        radius: {// [!code highlight]
          small: "2px", // rounded-sm [!code highlight]
          medium: "4px", // rounded-md [!code highlight]
          large: "6px", // rounded-lg [!code highlight]
        },// [!code highlight]
        borderWidth: { //  [!code highlight]
          small: "1px", // border[!code highlight]
          medium: "1px", // border-medium [!code highlight]
          large: "2px", // border-lg [!code highlight]
        },// [!code highlight]
      },
      themes: {
        light: {},
