...
<Alert
  className="mt-6"
  description="See the Layout section for more details about the available tokens."
/>
...
<Alert
  title="Important"
  description="When customizing colors, make sure to use only HSL values without color functions (e.g: `hsl()`)."
  color="danger"
/>
